...
Build up named lists.  [Very convenient for managing workspaces when used with used with `unpack`/`to`.](http://www.win-vector.com/blog/2020/01/using-unpack-to-manage-your-r-environment/)
