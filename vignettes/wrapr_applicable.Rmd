...
`wrapr` `1.1.0` includes de-referencing, function evaluation, and a new concept called `"wrapr_applicable"`.  `"wrapr_applicable"` is an early dispatch by type of right hand side argument scheme.
...
#' @export
#'
wrapr_function.ourclass <- function(pipe_left_arg, pipe_right_arg,
                                    pipe_environment) {
