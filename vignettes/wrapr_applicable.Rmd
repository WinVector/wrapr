...
The above is performed by standard `S3` dispatch on the left argument of an exported generic function called `pipe_step()`.  A formal description of `wrapr` piping can be found [here](https://github.com/WinVector/wrapr/blob/master/extras/wrapr_pipe.pdf).
