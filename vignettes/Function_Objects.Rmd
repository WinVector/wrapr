...
The idea is the `pipe_list` stores an arbitrary number of function objects as a simple list.  This list is easier to work with than function closures or pipelines.
