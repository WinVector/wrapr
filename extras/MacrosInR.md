...
It is, of course, an untenable burden to expect users to ingest even a partial history of methodology before they are allowed to try a new method. However a forgetful or even mendacious view of history on the part of method developers is counter productive, as [a lot of expensive and valuable lessons are lost in each re-invention](https://www.joelonsoftware.com/2000/04/06/things-you-should-never-do-part-i/).
