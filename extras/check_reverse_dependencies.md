...
```
    ...
    ## [1] "/var/folders/7q/h_jp2vj131g5799gfnpzhdp80000gn/T//RtmpNUfK5x"
...
```
    ...
    ## Ran from 2020-02-09 15:28:28 to 2020-02-09 15:32:49 for 4.35 mins 
    ## Average of 32.625 secs relative to 101.271 secs using 4 runners
    ## 
    ## Failed packages:   
    ## 
    ## Skipped packages:   
