...
In particular `base::bquote()` is able to easily program over `dplyr 0.7.0` and later versions and is part of the core `R` language (or "base `R`", which *should* be *huge* plus).
