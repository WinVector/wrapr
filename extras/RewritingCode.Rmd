...
new projects.  As for the second point: I feel the [`wrapr`](https://winvector.github.io/wrapr/) package is the easiest, safest, and most legible way to achieve maintainable code re-use in [`R`](https://cran.r-project.org).
