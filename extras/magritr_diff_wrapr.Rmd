...
and using the [`wrapr`](https://CRAN.R-project.org/package=wrapr) packge.
...
For comparion will work these examples using both `` magrittr::`%>%` `` and [`` wrapr::`%.>%` ``](https://winvector.github.io/wrapr/reference/grapes-.-greater-than-grapes.html).
